...
static const _MyNumberGame_Request_type_support_symbol_names_t _MyNumberGame_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, part4_services, srv, MyNumberGame_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, part4_services, srv, MyNumberGame_Request)),
  }
};
...
{
  return &::part4_services::srv::rosidl_typesupport_cpp::MyNumberGame_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, part4_services, srv, MyNumberGame_Request)() {
  return get_message_type_support_handle<part4_services::srv::MyNumberGame_Request>();
}
...
static const _MyNumberGame_Response_type_support_symbol_names_t _MyNumberGame_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, part4_services, srv, MyNumberGame_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, part4_services, srv, MyNumberGame_Response)),
  }
};
...
{
  return &::part4_services::srv::rosidl_typesupport_cpp::MyNumberGame_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, part4_services, srv, MyNumberGame_Response)() {
  return get_message_type_support_handle<part4_services::srv::MyNumberGame_Response>();
}
...
static const _MyNumberGame_type_support_symbol_names_t _MyNumberGame_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, part4_services, srv, MyNumberGame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, part4_services, srv, MyNumberGame)),
  }
};
...
{
  return &::part4_services::srv::rosidl_typesupport_cpp::MyNumberGame_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, part4_services, srv, MyNumberGame)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<part4_services::srv::MyNumberGame>();
}
