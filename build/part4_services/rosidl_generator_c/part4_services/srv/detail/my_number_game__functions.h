...
#ifndef PART4_SERVICES__SRV__DETAIL__MY_NUMBER_GAME__FUNCTIONS_H_
#define PART4_SERVICES__SRV__DETAIL__MY_NUMBER_GAME__FUNCTIONS_H_
...
#include "part4_services/msg/rosidl_generator_c__visibility_control.h"

#include "part4_services/srv/detail/my_number_game__struct.h"

/// Initialize srv/MyNumberGame message.
/**
...
/// Create srv/MyNumberGame message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * part4_services__srv__MyNumberGame_Request__init().
...
/// Destroy srv/MyNumberGame message.
/**
 * It calls
 * part4_services__srv__MyNumberGame_Request__fini()
...
/// Check for srv/MyNumberGame message equality.
/**
...
/// Copy a srv/MyNumberGame message.
/**
...
/// Initialize array of srv/MyNumberGame messages.
/**
...
/// Finalize array of srv/MyNumberGame messages.
/**
 * It calls
 * part4_services__srv__MyNumberGame_Request__fini()
...
/// Create array of srv/MyNumberGame messages.
/**
 * It allocates the memory for the array and calls
 * part4_services__srv__MyNumberGame_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MyNumberGame messages.
/**
 * It calls
 * part4_services__srv__MyNumberGame_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MyNumberGame message array equality.
/**
...
/// Copy an array of srv/MyNumberGame messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * part4_services__srv__MyNumberGame_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_part4_services
...
/**
 * It calls
 * part4_services__srv__MyNumberGame_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_part4_services
...
/**
 * It allocates the memory for the array and calls
 * part4_services__srv__MyNumberGame_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_part4_services
...
/**
 * It calls
 * part4_services__srv__MyNumberGame_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PART4_SERVICES__SRV__DETAIL__MY_NUMBER_GAME__FUNCTIONS_H_
